...
# This formula installs the Wazuh agent with ADORSYS-GIS security plugins and Snort IDS
...
class WazuhAgentBundleSnort < Formula
  ...
  test do
    assert_match "wazuh-agent-bundle-snort", shell_output("#{bin}/wazuh-agent --version 2>&1", 1)
  end
end
