...
# Homebrew formula for wazuh-agent-bundle-suricata
# This formula installs the Wazuh agent with ADORSYS-GIS security plugins and Suricata IDS/IPS

class WazuhAgentBundleSuricata < Formula
  desc "Bundled Wazuh agent with ADORSYS-GIS security plugins and Suricata IDS/IPS"
  ...
  test do
    assert_match "wazuh-agent-bundle-suricata", shell_output("#{bin}/wazuh-agent --version 2>&1", 1)
  end
end
