...
class WindowsDockerListener:
    ...
    def write_output(self, data, data_type="event"):
        ...
        try:
            ...
            logging.exception(f"Failed to write {data_type}")
    ...
    def stream_container_logs(self, container):
        ...
        try:
            ...
            logging.exception(f"Error streaming logs for {container_name}")
        finally:
            with self.lock:
    ...
    def sync_existing_containers(self):
        ...
        try:
            ...
            logging.exception("Failed to sync existing containers")

    def _process_event(self, event):
        """Helper to process a single Docker event."""
        # Record the event
        ...
        if self.capture_logs:
            ...
            if status == 'start':
                ...
                try:
                    ...
                    logging.exception(f"Could not find container {container_id} for logging")
    ...
    def listen_events(self):
        ...
        while not self.stop_event.is_set():
            ...
            try:
                ...
                logging.exception("Main stream interrupted")
                time.sleep(2)
