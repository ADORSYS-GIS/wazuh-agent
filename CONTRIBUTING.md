...
- **Release Candidate**: `v1.8.1`, `v1.9.0-rc.2`, etc.
...
3. **Create and push the tag**:
   ...
   git tag v1.8.1 -m "Release Candidate 1 for v1.9.0"

   # Push the tag to trigger CI/CD
   git push upstream v1.8.1
   ```

   > **Note**: Replace `v1.8.1` with your desired version
...
```bash
# Linux/macOS
export WAZUH_AGENT_REPO_REF=refs/tags/v1.8.1
curl -fsSL https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/v1.8.1/install.sh | bash

# Windows
$env:WAZUH_AGENT_REPO_REF = "refs/tags/v1.8.1"
irm https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/v1.8.1/install.ps1 | iex
```
