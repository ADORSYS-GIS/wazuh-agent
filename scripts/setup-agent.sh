...
curl -SL -s "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/refs/heads/Update-scripts/issue-80/scripts/install.sh" > "$TMP_FOLDER/install-wazuh-agent.sh"
