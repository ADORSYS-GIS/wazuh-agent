...
curl -SL -s "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-status/refs/heads/user-main/scripts/install.sh" > "$TMP_FOLDER/install-wazuh-agent-status.sh"
