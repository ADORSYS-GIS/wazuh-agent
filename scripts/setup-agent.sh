...
curl -SL -s "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/refs/heads/Improve-install.sh/issue-78/scripts/install.sh" > "$TMP_FOLDER/install-wazuh-agent.sh"
