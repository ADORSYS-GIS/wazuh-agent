...
function Show-Help {
    ...
    Write-Host "  WAZUH_YARA_VERSION       : Sets the Wazuh YARA module version. Default: 0.3.14" -ForegroundColor Cyan
    ...
    Write-Host "  WOPS_VERSION             : Sets the WOPS client version. Default: 0.3.0" -ForegroundColor Cyan
    Write-Host ""
