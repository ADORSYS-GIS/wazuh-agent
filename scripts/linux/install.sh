...
disable_repo() {
  # Disable Wazuh repository after installation for Linux
      ...
      elif [ "$PACKAGE_MANAGER" = "$YUM_PACKAGE" ] || [ "$PACKAGE_MANAGER" = "$ZYPPER_PACKAGE" ]; then
