...
download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-yara/${WAZUH_YARA_REPO_REF}/${LINUX_SCRIPT_PATH}" "$TMP_FOLDER/install-yara.sh" "${LINUX_SCRIPT_PATH}" "install-yara.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-yara/${WAZUH_YARA_REPO_REF}/checksums.sha256"
...
if [[ "$IDS_ENGINE" = "$SURICATA_ENGINE" ]]; then
    ...
    download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-suricata/${WAZUH_SURICATA_REPO_REF}/${LINUX_SCRIPT_PATH}" "$TMP_FOLDER/install-suricata.sh" "${LINUX_SCRIPT_PATH}" "install-suricata.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-suricata/${WAZUH_SURICATA_REPO_REF}/checksums.sha256"
