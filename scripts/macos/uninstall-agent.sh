...
download_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-yara/${WAZUH_YARA_REPO_REF}/scripts/macos/uninstall.sh" "$TMP_FOLDER/uninstall-yara.sh" "Yara uninstall script"
