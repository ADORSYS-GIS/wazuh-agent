...
download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-cert-oauth2/${WAZUH_CERT_OAUTH2_REPO_REF}/${MACOS_SCRIPT_PATH}" "$TMP_FOLDER/install-wazuh-cert-oauth2.sh" "${MACOS_SCRIPT_PATH}" "install-wazuh-cert-oauth2.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-cert-oauth2/${WAZUH_CERT_OAUTH2_REPO_REF}/checksums.sha256"
...
if ! download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/${WAZUH_AGENT_REPO_REF}/scripts/macos/setup-docker.sh" "$TMP_FOLDER/setup-docker.sh" "scripts/macos/setup-docker.sh" "setup-docker.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/${WAZUH_AGENT_REPO_REF}/checksums.sha256"; then
...
if ! curl -s https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-installer/refs/tags/v1.2.0/install-scripts/macos.sh | bash -s latest; then
