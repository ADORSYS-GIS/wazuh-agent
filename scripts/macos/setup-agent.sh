...
WAZUH_SNORT_VERSION=${WAZUH_SNORT_VERSION:-"main"}
...
uninstall_snort() {
    if command_exists snort; then
        ...
        download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-snort/${WAZUH_SNORT_REPO_REF}/scripts/macos/uninstall.sh" "$TMP_FOLDER/uninstall-snort.sh" "scripts/macos/uninstall.sh" "uninstall-snort.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-snort/${WAZUH_SNORT_REPO_REF}/checksums.sha256"
...
download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-cert-oauth2/${WAZUH_CERT_OAUTH2_REPO_REF}/scripts/macos/install.sh" "$TMP_FOLDER/install-wazuh-cert-oauth2.sh" "scripts/macos/install.sh" "install-wazuh-cert-oauth2.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-cert-oauth2/${WAZUH_CERT_OAUTH2_REPO_REF}/checksums.sha256"

download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-status/${WAZUH_AGENT_STATUS_REPO_REF}/scripts/macos/install.sh" "$TMP_FOLDER/install-wazuh-agent-status.sh" "scripts/macos/install.sh" "install-wazuh-agent-status.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-status/${WAZUH_AGENT_STATUS_REPO_REF}/checksums.sha256"

download_and_verify_file "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-yara/${WAZUH_YARA_REPO_REF}/scripts/macos/install.sh" "$TMP_FOLDER/install-yara.sh" "scripts/macos/install.sh" "install-yara.sh" "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-yara/${WAZUH_YARA_REPO_REF}/checksums.sha256"
...
USB_DLP_BASE_URL="https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/$WAZUH_AGENT_REPO_REF/files/active-response/macos"
